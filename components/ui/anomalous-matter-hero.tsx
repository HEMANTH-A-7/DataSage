  ...
  useEffect(() => {
    ...
    const material = new THREE.ShaderMaterial({
      uniforms: {
        ...
        color: { value: new THREE.Color("#5ed29c") }, // Same color palette as DataSage (mint green)
      },
      vertexShader: `
                uniform float time;
    ...
    const animate = (t: number) => {
      if (materialRef.current) {
        materialRef.current.uniforms.time.value = t * 0.0003;
      }
    ...
    const handleMouseMove = (e: MouseEvent) => {
      ...
      materialRef.current.uniforms.pointLightPos.value = pos;
    };
